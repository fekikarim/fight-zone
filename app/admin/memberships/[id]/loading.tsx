export default function AdminMembershipEditLoading() {
  return (
    <div className="flex max-w-none flex-col gap-8 px-0">
      ...
      <div className="mx-auto w-full max-w-2xl space-y-6">
        <div className="h-20 animate-pulse rounded-lg border border-ink-border bg-ink-soft/30" />
        ...
        <div className="h-10 w-40 animate-pulse rounded-lg bg-ink-soft" />
      </div>
    </div>
  );
}
