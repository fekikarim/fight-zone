...
select tests_expect_rows(
  ...
  'select * from public.notifications where user_id = :' || quote_literal('00000000-0000-0000-0000-000000000002') || '::uuid and is_read = false',
  1
);
...
select tests_expect_affected(
  ...
  'update public.notifications set user_id = :' || quote_literal('00000000-0000-0000-0000-000000000006') || '::uuid where id = ''aaaa0000-0000-0000-0000-000000000001''::uuid',
  0
);
...
select tests_expect_affected(
  ...
  'update public.notifications set is_read = true where is_read = false and user_id = :' || quote_literal('00000000-0000-0000-0000-000000000002') || '::uuid',
  1
);
...
select tests_expect_rows(
  ...
  'select * from public.notifications where user_id = :' || quote_literal('00000000-0000-0000-0000-000000000001') || '::uuid and is_read = false',
  1
);
...
values ('00000000-0000-0000-0000-000000000002', 'SYSTEM', 'System test', 'No resource', null, null);
select tests_set_auth('00000000-0000-0000-0000-000000000002', true);
select tests_expect_rows(
...
values ('33333333-3333-3333-3333-333333333333', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001');
...
select tests_expect_rows(
  ...
  'select * from public.notifications where user_id = :' || quote_literal('00000000-0000-0000-0000-000000000001') || '::uuid and resource_type = ''conversation'' and resource_id = ''33333333-3333-3333-3333-333333333333''::uuid',
  1
);
